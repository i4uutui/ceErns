...
const { SubProductsCode, SubCustomerInfo, SubPartCode, SubMaterialCode, SubSaleOrder, Op } = require('../models');
 ...
 */
const createGetListHandler = (Model, labelField, include) => async (req, res) => {
  const { company_id } = req.user;
